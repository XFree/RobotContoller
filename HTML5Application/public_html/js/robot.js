...
var Robot = createClass({
    ...
    connect: function(_cbReadyState, _cbConnectionLost, _sImgSelector) {
        ...
        if (!!window.EventSource) {
            ...
            this._source.addEventListener('message', function(_oEvent) {
                _this._onServerMessage(_oEvent);
            }, false);
            this._source.addEventListener('open', function(_oEvent) {
                _this._onConnectionOpen(_oEvent);
            }, false);
            this._source.addEventListener('error', function(_oEvent) {
                _this._onConnectionLost(_oEvent);
            }, false);
        }
        return this._source;
    },
